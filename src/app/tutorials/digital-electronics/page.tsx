...
import { Binary as DigitalIcon, ChevronRight } from 'lucide-react';
    ...
    <div className="w-full">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Browse through the complete list of lessons in the Digital Electronics series.</CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="space-y-2">
            {digitalElectronicsLessons.map((lesson) => (
              <li key={lesson.slug}>
                <Link href={`/tutorials/digital-electronics/${lesson.slug}`} className="block p-4 rounded-md transition-colors hover:bg-muted/50">
