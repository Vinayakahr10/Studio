...
import { getOscillatorLessonBySlug, oscillatorLessons } from '@/data/oscillator-lessons'; 
...
export default function OscillatorLessonPage({ params }: LessonPageProps) {
  ...
  const currentIndex = oscillatorLessons.findIndex(l => l.slug === params.lessonSlug);
