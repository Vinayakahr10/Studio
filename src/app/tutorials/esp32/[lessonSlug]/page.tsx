...
import { getESP32LessonBySlug, esp32TutorialLessons } from '@/data/esp32-tutorial-data'; 
...
export default function ESP32LessonPage({ params }: LessonPageProps) {
  ...
  const currentIndex = esp32TutorialLessons.findIndex(l => l.slug === params.lessonSlug);
