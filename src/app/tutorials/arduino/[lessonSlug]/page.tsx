...
import { getArduinoLessonBySlug, arduinoTutorialLessons } from '@/data/arduino-tutorial-data.tsx'; 
...
export default function ArduinoLessonPage({ params }: LessonPageProps) {
  ...
  const currentIndex = arduinoTutorialLessons.findIndex(l => l.slug === params.lessonSlug);
