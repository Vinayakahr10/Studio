...
import { getSemiconductorDeviceLessonBySlug, semiconductorDeviceLessons } from '@/data/semiconductor-devices-lessons'; 
...
export default function SemiconductorDeviceLessonPage({ params }: LessonPageProps) {
  ...
  const currentIndex = semiconductorDeviceLessons.findIndex(l => l.slug === params.lessonSlug);
    ...
    <article className="w-full">
      ...
      <nav className="flex justify-between items-center">
        <div>
          {prevLesson && (
            <Button asChild variant="outline">
              <Link href={`/tutorials/semiconductor-devices/${prevLesson.slug}`} className="flex items-center">
        ...
        <div>
          {nextLesson && (
            <Button asChild variant="outline">
              <Link href={`/tutorials/semiconductor-devices/${nextLesson.slug}`} className="flex items-center">
