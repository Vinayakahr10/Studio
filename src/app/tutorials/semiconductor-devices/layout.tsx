...
export default function SemiconductorDevicesLayout({
  children,
}: {
  children: ReactNode;
}) {
    ...
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-var(--header-height,4rem)-var(--footer-height,4rem))]">
      ...
      <div className={cn(
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <h3 className={cn("text-xl font-semibold text-primary", !isSidebarOpen && "hidden")}>Semiconductor Devices</h3>
         ...
         <div className={cn("flex-grow overflow-y-auto", !isSidebarOpen && "overflow-y-hidden")}>
          <TutorialSidebar 
              lessons={semiconductorDeviceLessons} 
              basePath="/tutorials/semiconductor-devices"
      ...
      <div className="md:hidden p-4 border-b border-border bg-card shadow-sm">
         <div className="flex justify-between items-center mb-3">
            ...
            <Button 
              ...
              aria-controls="mobile-lesson-list-semiconductor"
            >
        ...
        {isMobileLessonsExpanded && (
          <div id="mobile-lesson-list-semiconductor">
              <TutorialSidebar 
                  lessons={semiconductorDeviceLessons} 
                  basePath="/tutorials/semiconductor-devices"
                  showSidebarHeader={false} 
