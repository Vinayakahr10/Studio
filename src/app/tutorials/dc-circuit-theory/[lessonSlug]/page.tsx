...
export default function DCCircuitLessonPage({ params }: LessonPageProps) {
  ...
  const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { label: 'DC Circuit Theory', href: '/tutorials/dc-circuit-theory' },
    { label: lesson.title }, // Use the short title for breadcrumb
  ];

  const currentIndex = dcCircuitLessons.findIndex(l => l.slug === lesson.slug);
  ...
  const TopicIcon = lesson.Icon || Zap;
    ...
    <article className="w-full">
      ...
      <header className="mb-8 md:mb-10 pb-6 border-b">
         <div className="flex items-center text-primary mb-3">
            ...
            <span className="text-sm font-medium tracking-wide uppercase">DC CIRCUIT THEORY</span>
        </div>
