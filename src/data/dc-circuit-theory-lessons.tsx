...
export const dcCircuitLessons: DCCircuitLesson[] = [
  ...
  { slug: toSlug("2. Electrical Units"), title: "2. Electrical Units", description: "Understanding voltage, current, resistance, and power units.", difficulty: "Beginner", Icon: Settings, content: comingSoonContent },
  { slug: toSlug("3. Ohm's Law & Power"), title: "3. Ohm's Law & Power", description: "Fundamental V-I-R relationship and power calculations.", difficulty: "Beginner", Icon: Sigma, content: comingSoonContent },
  { slug: toSlug("4. Electrical Energy"), title: "4. Electrical Energy", description: "Concepts of energy, consumption, efficiency, and conversion.", difficulty: "Beginner", Icon: FileText, content: comingSoonContent },
  { slug: toSlug("5. Voltage Sources"), title: "5. Voltage Sources", description: "Ideal and real voltage sources, internal resistance, models.", difficulty: "Beginner", Icon: Zap, content: comingSoonContent },
  { slug: toSlug("6. Current Sources"), title: "6. Current Sources", description: "Ideal and real current sources, internal resistance, models.", difficulty: "Beginner", Icon: Zap, content: comingSoonContent },
  { slug: toSlug("7. Kirchhoff's Laws"), title: "7. Kirchhoff's Laws", description: "General introduction to Kirchhoff's fundamental circuit laws.", difficulty: "Intermediate", Icon: UserCheck, content: comingSoonContent },
  { slug: toSlug("8. KCL"), title: "8. KCL", description: "In-depth exploration of KCL, node analysis, and current conservation.", difficulty: "Intermediate", Icon: UserCheck, content: comingSoonContent },
  { slug: toSlug("9. KVL"), title: "9. KVL", description: "Detailed explanation of KVL, loop analysis, and voltage conservation.", difficulty: "Intermediate", Icon: UserCheck, content: comingSoonContent },
  { slug: toSlug("10. Voltage Divider"), title: "10. Voltage Divider", description: "Voltage division in series circuits and practical applications.", difficulty: "Intermediate", Icon: Settings, content: comingSoonContent },
  { slug: toSlug("11. Current Divider"), title: "11. Current Divider", description: "Current division in parallel circuits and practical applications.", difficulty: "Intermediate", Icon: Settings, content: comingSoonContent },
  { slug: toSlug("12. DC Series Circuit"), title: "12. DC Series Circuit", description: "Analysis of series-connected components, equivalent R, voltage distribution.", difficulty: "Intermediate", Icon: BookOpen, content: comingSoonContent },
  { slug: toSlug("13. DC Parallel Circuit"), title: "13. DC Parallel Circuit", description: "Analysis of parallel-connected components, equivalent R, current distribution.", difficulty: "Intermediate", Icon: BookOpen, content: comingSoonContent },
  { slug: toSlug("14. Combination Circuits"), title: "14. Combination Circuits", description: "Analysis techniques for circuits with series and parallel connections.", difficulty: "Intermediate", Icon: BookOpen, content: comingSoonContent },
  { slug: toSlug("15. Star-Delta Transform"), title: "15. Star-Delta Transform", description: "Convert between star (Y) and delta (Δ) to simplify analysis.", difficulty: "Advanced", Icon: Settings, content: comingSoonContent },
  { slug: toSlug("16. Mesh Current Analysis"), title: "16. Mesh Current Analysis", description: "Systematic approach to solve circuits by analyzing mesh currents (KVL).", difficulty: "Advanced", Icon: Sigma, content: comingSoonContent },
  { slug: toSlug("17. Nodal Voltage Analysis"), title: "17. Nodal Voltage Analysis", description: "Systematic approach to solve circuits by analyzing node voltages (KCL).", difficulty: "Advanced", Icon: Sigma, content: comingSoonContent },
  { slug: toSlug("18. Thevenin's Theorem"), title: "18. Thevenin's Theorem", description: "Simplifying circuits into an equivalent voltage source and series R.", difficulty: "Advanced", Icon: FileText, content: comingSoonContent },
  { slug: toSlug("19. Norton's Theorem"), title: "19. Norton's Theorem", description: "Simplifying circuits into an equivalent current source and parallel R.", difficulty: "Advanced", Icon: FileText, content: comingSoonContent },
  { slug: toSlug("20. Superposition"), title: "20. Superposition", description: "Analyzing circuits with multiple sources by considering one at a time.", difficulty: "Advanced", Icon: CheckCircle2, content: comingSoonContent },
  { slug: toSlug("21. Max Power Transfer"), title: "21. Max Power Transfer", description: "Conditions for transferring maximum power from a source to a load.", difficulty: "Advanced", Icon: Zap, content: comingSoonContent },
];
